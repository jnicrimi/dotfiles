...
sync_symlinks ".claude/skills/create-branch" "SKILL.md"
sync_symlinks ".claude/skills/local-review" "SKILL.md"
sync_symlinks ".claude/skills/make-commit" "SKILL.md"
sync_symlinks ".claude/skills/show-summary" "SKILL.md"
